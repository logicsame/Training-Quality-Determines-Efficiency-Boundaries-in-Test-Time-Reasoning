...
USAGE:
    python token_ablation_analysis_large_models.py --base_dir data/raw/phase3_responses
"""
...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='./token_ablation_r1_model_large_analysis',
