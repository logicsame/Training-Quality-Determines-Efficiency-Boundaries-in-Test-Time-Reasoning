...
USAGE:
    python token_ablation_standard_model.py --base_dir data/raw/phase1_responses
"""
...
def load_model_data(model_dir: Path) -> Dict:
    ...
    for dataset in DATASETS:
        ...
        if not dataset_dir.exists():
            print(f"   ⚠️  Missing dataset directory: {dataset}")
            continue
...
def main():
    ...
    parser.add_argument('--output_dir', type=str, default='./token_ablation_analysis_standard',
