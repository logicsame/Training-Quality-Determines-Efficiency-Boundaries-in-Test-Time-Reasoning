...
class ModelManager:
    ...
    Loads models directly from HuggingFace hub using transformers.
    """
    ...
    def generate(self, prompt: str, max_new_tokens: int = 300) -> Tuple[str, float, int, int]:
        ...
        Returns: (full_text, generation_time, input_tokens, output_tokens)
        """
        import time
        ...
        generation_only = full_text[len(self.tokenizer.decode(
